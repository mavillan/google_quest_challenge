...
columns0 = [
	("question_conversational", 1/4),
	("question_multi_intent", 1/2),
	("question_not_really_a_question", 1/4),
	("question_type_choice", 1/2),
	("question_type_compare", 1/4),
	("question_type_consequence", 1/4),
	("question_type_definition", 1/4),
	("question_type_entity", 1/4),
	("question_type_spelling", 1/4),
	("answer_type_procedure", 1/2)
]

columns1 = [
	("question_fact_seeking", 4),
	("question_has_commonly_accepted_answer", 2),
	("answer_helpful", 2),
	("answer_plausible", 4),
	("answer_relevance", 4),
	("answer_well_written", 2)
]

for column,p in columns0+columns1:
	train.loc[:, column] = train.loc[:, column]**(p)
