...
def train_mlp(model_class, train_data, train_targets, 
	...
	model = model_class(dropout=DROPOUT, input_size=1024, output_size=30)
	model.cuda()
...
for fold, (train_idx, valid_idx) in enumerate(kf_split):
	...
	model = BERTRegressor(bert_path=BERT_PATH, dropout=DROPOUT, hidden_size=1024, output_size=30)
